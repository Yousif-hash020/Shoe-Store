...
<head>
    ...
    <title>{{ ucfirst($category) }} Products - EliteKicks</title>
    <!-- Bootstrap CSS -->
...
<body>
    ...
    <section class="page-header">
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <h1 class="page-title">{{ ucfirst($category) }} Products</h1>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="d-flex justify-content-between align-items-center mb-4">
                        <p class="mb-0">Showing {{ $products->count() }} of {{ $products->total() }} {{ $category }} products</p>
                    ...
                    <div class="text-center py-5">
                        ...
                        <h4 class="mt-3">No {{ $category }} products found</h4>
                        <p class="text-muted">Check back later for new arrivals in this category.</p>
